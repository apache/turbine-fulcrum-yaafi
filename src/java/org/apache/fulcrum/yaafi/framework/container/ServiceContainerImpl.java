...
public class ServiceContainerImpl implements ServiceContainer, ServiceConstants
{
    ...
    public void initialize() throws Exception
    {
        ...
        List<ServiceComponent> currServiceList = this.createServiceComponents( this.roleConfiguration,
                this.getLogger() );
    ...
    /**
     * Reconfiguring the services. I'm not sure how to implement this properly since the
     * Avalon docs is vague on this subject. For now we suspend, reconfigure and resume the
    ...
    /**
     * Configure a single service component. After the invocation the service component is
     * ready to be incarnated.
     *
    ...
    /**
     * Incarnation of a configured service component. After the incarnation the service
    ...
    /**
     * Decommission of a single service component. Decommission consists of running the whole
     * Avalon decommission lifecycle process for a service component. After decommission the
     * service is not operational any longer. During decommissioning we ignore any exceptions
     * since it is quite common that something goes wrong.
     *
    ...
    /**
     * Factory method for creating services. The service instances are not initialized at this
     * point.
     *
    ...
    /**
     * Creates a locator to find a resource either in the file system or in the classpath.
     *
     * @return the locator
     */
    ...
    /**
     * Wait for the time configured as 'reconfigurationDelay' before reconfiguring the
    ...
    /**
     * Wait for the time configured as 'disposalDelay' before disposing the container.
     */
